...
--
-- Host: localhost
-- Generation Time: Apr 06, 2024 at 05:41 PM
...
INSERT INTO `MotionPicture` (`mid`, `name`, `rating`, `Production`, `budget`) VALUES
...
CREATE TABLE `Movie` (
  `mpid` varchar(11) NOT NULL,
  `boxoffice_collection` double NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `Award`
  ...
  ADD KEY `mpid` (`mpid`,`pid`),
  ADD KEY `award_p_same` (`pid`);
...
ALTER TABLE `Likes`
  ...
  ADD KEY `user_like_same_key` (`uemail`);
...
--
ALTER TABLE `Award`
  ADD CONSTRAINT `award_m_same` FOREIGN KEY (`mpid`) REFERENCES `cosi127b`.`MotionPicture` (`mid`),
  ADD CONSTRAINT `award_p_same` FOREIGN KEY (`pid`) REFERENCES `cosi127b`.`People` (`pid`);

--
-- Constraints for table `Genre`
--
ALTER TABLE `Genre`
  ADD CONSTRAINT `genre_same` FOREIGN KEY (`mpid`) REFERENCES `cosi127b`.`MotionPicture` (`mid`);

--
-- Constraints for table `Likes`
--
ALTER TABLE `Likes`
  ADD CONSTRAINT `likes_same_key` FOREIGN KEY (`mpid`) REFERENCES `cosi127b`.`MotionPicture` (`mid`),
  ADD CONSTRAINT `user_like_same_key` FOREIGN KEY (`uemail`) REFERENCES `cosi127b`.`User` (`email`);

--
-- Constraints for table `Location`
--
ALTER TABLE `Location`
  ADD CONSTRAINT `location_same_key` FOREIGN KEY (`mpid`) REFERENCES `cosi127b`.`MotionPicture` (`mid`);

--
-- Constraints for table `Role`
--
ALTER TABLE `Role`
  ADD CONSTRAINT `rolem_same` FOREIGN KEY (`mpid`) REFERENCES `cosi127b`.`MotionPicture` (`mid`),
  ADD CONSTRAINT `rolep_same` FOREIGN KEY (`pid`) REFERENCES `cosi127b`.`People` (`pid`);

--
-- Constraints for table `Series`
--
ALTER TABLE `Series`
  ADD CONSTRAINT `same key` FOREIGN KEY (`mpid`) REFERENCES `cosi127b`.`MotionPicture` (`mid`);
COMMIT;
